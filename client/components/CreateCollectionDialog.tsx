              ...
              {uploadedImage || initialCoverImage ? (
                ...
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="flex p-[10px] flex-col justify-center items-center gap-[10px] rounded-[10px] border-3 border-promag-primary">
                    ...
                    >
                      <path
                        d="M31.5088 27.9976L23.5088 19.9976L15.5088 27.9976"
                        stroke="#722555"
                        strokeWidth="3"
                        strokeLinecap="round"
                      ...
                      />
                      <path
                        d="M40.2887 32.7775C42.2394 31.7141 43.7804 30.0313 44.6685 27.9948C45.5565 25.9583 45.7411 23.684 45.1931 21.5309C44.6451 19.3778 43.3957 17.4686 41.642 16.1044C39.8884 14.7403 37.7304 13.999 35.5087 13.9975H32.9887C32.3833 11.656 31.255 9.4822 29.6886 7.63951C28.1222 5.79683 26.1584 4.33323 23.9449 3.35874C21.7314 2.38426 19.3258 1.92424 16.9089 2.01329C14.4921 2.10234 12.1268 2.73813 9.99106 3.87286C7.85528 5.00759 6.00453 6.61173 4.57795 8.56469C3.15137 10.5176 2.18609 12.7686 1.75467 15.1483C1.32325 17.528 1.43692 19.9746 2.08714 22.304C2.73735 24.6335 3.90719 26.7853 5.50871 28.5975"
                        stroke="#722555"
                        strokeWidth="3"
                        strokeLinecap="round"
                        strokeLinejoin="round"
