...
const mockTranslationData: TranslationEntry[] = [
  {
    ...
    content: "Create it free and you will always have thee desired document griffeltingal",
    language: "English"
  },
  {
    id: "2", 
...
const EditIcon = () => (
  <svg width="20" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.66797 3.33325H3.83464C3.39261 3.33325 2.96868 3.50885 2.65612 3.82141C2.34356 4.13397 2.16797 4.55789 2.16797 4.99992V16.6666C2.16797 17.1086 2.34356 17.5325 2.65612 17.8451C2.96868 18.1577 3.39261 18.3333 3.83464 18.3333H15.5013C15.9433 18.3333 16.3673 18.1577 16.6798 17.8451C16.9924 17.5325 17.168 17.1086 17.168 16.6666V10.8333" stroke="#722555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M15.918 2.08344C16.2495 1.75192 16.6991 1.56567 17.168 1.56567C17.6368 1.56567 18.0864 1.75192 18.418 2.08344C18.7495 2.41496 18.9357 2.8646 18.9357 3.33344C18.9357 3.80228 18.7495 4.25192 18.418 4.58344L10.5013 12.5001L7.16797 13.3334L8.0013 10.0001L15.918 2.08344Z" stroke="#722555" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const DeleteIcon = () => (
  <svg width="20" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 5H4.66667H18" stroke="#D9534F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M7.16797 5.00008V3.33341C7.16797 2.89139 7.34356 2.46746 7.65612 2.1549C7.96868 1.84234 8.39261 1.66675 8.83464 1.66675H12.168C12.61 1.66675 13.0339 1.84234 13.3465 2.1549C13.659 2.46746 13.8346 2.89139 13.8346 3.33341V5.00008M16.3346 5.00008V16.6667C16.3346 17.1088 16.159 17.5327 15.8465 17.8453C15.5339 18.1578 15.11 18.3334 14.668 18.3334H6.33464C5.89261 18.3334 5.46868 18.1578 5.15612 17.8453C4.84356 17.5327 4.66797 17.1088 4.66797 16.6667V5.00008H16.3346Z" stroke="#D9534F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M8.83203 9.16675V14.1667" stroke="#D9534F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M12.168 9.16675V14.1667" stroke="#D9534F" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

const SortIcon = () => (
  <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M4.1526 7.83332H11.8506C12.4253 7.83332 12.7306 7.15332 12.3486 6.72332L8.49993 2.39331C8.4375 2.32285 8.36083 2.26644 8.27499 2.2278C8.18914 2.18917 8.09607 2.16919 8.00193 2.16919C7.90779 2.16919 7.81472 2.18917 7.72888 2.2278C7.64303 2.26644 7.56636 2.32285 7.50393 2.39331L3.65393 6.72332C3.27193 7.15332 3.57726 7.83332 4.1526 7.83332ZM7.50326 14.606C7.56569 14.6764 7.64236 14.7329 7.72821 14.7715C7.81406 14.8101 7.90712 14.8301 8.00126 14.8301C8.0954 14.8301 8.18847 14.8101 8.27432 14.7715C8.36017 14.7329 8.43684 14.6764 8.49926 14.606L12.3479 10.276C12.7306 9.84665 12.4253 9.16665 11.8499 9.16665H4.1526C3.57793 9.16665 3.2726 9.84665 3.6546 10.2766L7.50326 14.606Z" fill="#9E9E9E"/>
  </svg>
);

export function CompanyTranslationTable({ className }: CompanyTranslationTableProps) {
  const { t } = useTranslation();
  const [searchQuery, setSearchQuery] = useState("");
  const [translations, setTranslations] = useState<TranslationEntry[]>(mockTranslationData);
  const [sortField, setSortField] = useState<keyof TranslationEntry | null>(null);
  ...
  return (
    <div className={cn("flex flex-col gap-5", className)}>
      ...
      <div className="flex items-center gap-2 text-sm font-inter font-medium">
        ...
        <span className="text-promag-primary">{t("translation.table.title")}</span>
      </div>
