...
const navItems = [
  {
    icon: (
      ...
      >
        <path
          d="M3.79907 6.4V1.5H12.1991V6.4"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        ...
        />
        <path
          d="M3.8 12.7H2.4C2.0287 12.7 1.6726 12.5525 1.41005 12.29C1.1475 12.0274 1 11.6713 1 11.3V7.80002C1 7.42872 1.1475 7.07263 1.41005 6.81008C1.6726 6.54752 2.0287 6.40002 2.4 6.40002H13.6C13.9713 6.40002 14.3274 6.54752 14.5899 6.81008C14.8525 7.07263 15 7.42872 15 7.80002V11.3C15 11.6713 14.8525 12.0274 14.5899 12.29C14.3274 12.5525 13.9713 12.7 13.6 12.7H12.2"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M12.1991 9.90002H3.79907V15.5H12.1991V9.90002Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    icon: (
      ...
      >
        <path
          d="M1 7.16661L8 1.72217L15 7.16661V15.7222C15 16.1347 14.8361 16.5304 14.5444 16.8221C14.2527 17.1138 13.857 17.2777 13.4444 17.2777H2.55556C2.143 17.2777 1.74733 17.1138 1.45561 16.8221C1.16389 16.5304 1 16.1347 1 15.7222V7.16661Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M5.66675 17.2778V9.5H10.3334V17.2778"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export function Sidebar({
  ...
  return (
    <div
      className={cn(
        "flex w-[260px] h-screen flex-col items-center bg-promag-primary px-[10px]",
        className,
      )}
    >
      {/* Logo */}
